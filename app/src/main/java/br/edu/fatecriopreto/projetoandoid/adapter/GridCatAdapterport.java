 ...
 */
public class GridCatAdapterport extends BaseAdapter {
    private LayoutInflater inflater;
    private List<Categorias> categorias;

    public GridCatAdapterport(Context context,List<Categorias> categorias){
    ...
    public View getView(int position, View convertView, ViewGroup parent) { //metodo que preenche o layout com os dados do item
        ItemSuporte item;
        if(convertView==null){
            convertView = inflater.inflate(R.layout.itemgridportatil, null); //coloca o layout na visualização
